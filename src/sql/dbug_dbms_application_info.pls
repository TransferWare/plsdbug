...
REMARK
REMARK  $HeadURL: https://svn.code.sf.net/p/transferware/code/trunk/plsdbug/src/sql/dbug_dbms_application_info.pls $
REMARK

WHENEVER SQLERROR EXIT FAILURE

create or replace package dbug_dbms_application_info is
...
@@dbug_verify dbug_dbms_application_info package
...
@@dbug_verify dbug_dbms_application_info "package body"
